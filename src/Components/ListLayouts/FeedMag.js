    ...
    return (
        <>
            <label className="feed-mag" htmlFor="listImage1" style={{ width: "100%", boxSizing: "border-box", display: "flex", boxShadow: "rgba(0, 0, 0, 0.05) 0px 4px 24px 1px", padding: "2rem", borderRadius: "1.5rem", backgroundColor: '#fff', margin: "1rem 0" }}>
                <div className="tile-image" style={{ position: 'relative', display: "flex", alignItems: "center", width: "24%", marginRight: "4%" }}>
                    <img src={image ? image : 'plus.png'} style={{ width: "100%", objectFit: "cover", borderRadius: "12px", height: tablet ? "24rem" : "12rem" }} alt="" />
